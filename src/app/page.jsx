    ...
    <main className="overflow-x-hidden font-[arial]">
      <section className="w-screen h-screen p-4 pt-12 text-main-fourth text-center flex flex-col justify-center items-center">
        ...
        <h1 className="text-4xl font-bold mb-4">
          TEMPAT ANDA MELEPAS RASA BOSAN ANDA
        </h1>
        <button
          className="bg-main-third p-4 rounded-3xl font-bold text-3xl mb-2"
          onClick={() => srcollMenu()}
        >
          Dengan berbagai menu
        </button>
        <p className="text-lg">
          web yang dapat melepas kebosanan anda dengan berbagai menu yang ada di
          sini.
        </p>
      </section>
      <section className="w-screen h-screen p-4 pt-12 flex flex-col-reverse md:flex-row justify-evenly items-center self-start">
        <div className="md:w-5/12 w-full lg:h-48 md:h-50 h-70 p-4 border-2 rounded-3xl overflow-y-auto md:overflow-y-visible shadow-[15px_15px_10px_0px_rgb(0,0,0,0.5)]">
          <h1 className="font-bold mb-4">TAHUGABUT</h1>
      ...
      <section className="p-4 w-full h-screen" ref={refMenu}>
        <h1 className="text-3xl font-bold">Berbagai menu</h1>
        <div className="mt-4 grid md:grid-cols-4 grid-cols-2 gap-4">
          ...
          <Card
            title="TahuAI"
            description="AI yang dapat membantu menjawap pertanyaan anda."
            href="/ai"
          />
          <Card
            title="Ramal"
            description="adalah tempat di mana anda bisa mencoba ramalan anda di hari ini beserta saran dan larangan nya."
            href="/ramal"
          />
        </div>
      </section>
