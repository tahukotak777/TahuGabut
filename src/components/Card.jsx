...
const Card = ({ title, description, href}) => {
    return ( 
        <div className="p-4 border-2 rounded-xl w-full h-full shadow-[10px_10px_10px_0px_rgb(0,0,0,0.8)]">
            ...
            <Link href={href} className='bg-main-primary hover:bg-main-third text-main-third hover:text-main-fourth transition-all duration-200 flex h-8 items-center justify-center font-bold rounded'>Go To</Link>
        </div>
     );
}
